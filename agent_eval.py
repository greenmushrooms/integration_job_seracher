...
class ClaudeJobEvaluator:
    ...
    def evaluate(self, resume: str, jobs_df: pd.DataFrame) -> pd.DataFrame:
        ...
        for idx, job in jobs_df.iterrows():
            ...
            try:
                ...
                results.append(
                    {"job_id": job.get("id"), "error": str(e), "avg_score": 0}
                )
    ...
    def _score_job_with_tool(self, job: pd.Series, system_messages: List[Dict]) -> Dict:
        ...
        message = self.client.messages.create(
            model=self.model,
            max_tokens=2000,  # Increased from 802 for safety
            temperature=0,  # Set to 0 for consistent JSON
        ...
        data = tool_use.input  # This is a native Python dictionary now
        ...
        return {
            ...
            "tech_analysis": json.dumps(data.get("tech_stack_analysis")),
